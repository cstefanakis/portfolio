<template>
    <div class="article-content">  
        <div class = "title">
                <svg class ="title-icon" xmlns="http://www.w3.org/2000/svg" version="1.0" viewBox="0 0 512.000000 512.000000" preserveAspectRatio="xMidYMid meet">
        ...
        <div class = "hi">Hi from <span class ="first-name"> Christos </span>, Java Developer</div>
        <p>I enjoy programming and love learning new things, especially when it comes to technology and software development. I'm always curious and eager to expand my skills</p>
    </div>
</template>
